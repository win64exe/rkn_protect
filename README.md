...
```bash
curl -o rkn_protect.sh [https://raw.githubusercontent.com/win64exe/rkn_protect/main/rkn_protect.sh](https://raw.githubusercontent.com/win64exe/rkn_protect/main/rkn_protect.sh)
